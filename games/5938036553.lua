...
local drawingactor = loadstring(downloadFile('atomware/libraries/drawing.lua'), 'drawing')(...)
...
if not select(1, ...) and game.PlaceId == 5938036553 then
	if run_on_actor and getactors then
		...
		task.spawn(function()
			...
			local executionString = "loadfile('atomware/main.lua')("..drawingactor..")"
...
local function addBlur(parent)
	...
	blur.Image = getcustomasset('atomware/assets/new/blur.png')
